...
public class BillFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Số phiếu", "Loại tô", "Số lượng", "Thành tiền"
            }
        ) {
        ...
        jLabel2.setText("Số bàn cần thanh toán");

        txtBan.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        btnSearch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_search_40px.png"))); // NOI18N
        ...
        btnThanhToan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_expensive_price_40px.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_sigma_40px.png"))); // NOI18N
        jLabel3.setText("TỔNG TIỀN");

        btnCancel.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_cancel_40px_1.png"))); // NOI18N
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        else if (soban < 1 || soban > 30){
            JOptionPane.showMessageDialog(rootPane, "Số bàn không hợp lệ. Số bàn trong quán chỉ từ 1 - 30.");
            txtBan.setText("");
            txtBan.requestFocus();
        }
        else {
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        if (GoiMonBUS.updateHD(txtBan.getText(), lbtong.getText()) && GoiMonBUS.banTrong(txtBan.getText())){
    ...
    public void loadTable() {
        ...
        GoiMonBUS gmBUS = new GoiMonBUS();
        ArrayList<ArrayList<String>> LIST = new ArrayList<ArrayList<String>>();
        long tongtien = 0;
        LIST = gmBUS.getG(txtBan.getText());
        if (LIST.size() > 0) {
            for (int i = 0; i < LIST.size(); i++) {
                Vector<String> dong = new Vector<String>(LIST.get(i));
                tongtien = tongtien + Long.parseLong(LIST.get(i).get(3));
                dtm.addRow(dong);
            }

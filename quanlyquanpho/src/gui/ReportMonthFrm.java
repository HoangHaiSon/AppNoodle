 ...
 * @author HoangHaiSon
 */
public class ReportMonthFrm extends javax.swing.JFrame {

    /**
     * Creates new form BillFrm
     */
    public ReportMonthFrm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("THÁNG CẦN BÁO CÁO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportMonthFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportMonthFrm().setVisible(true);
            }
        });
    }
    ...
    public void loadTable() {
        ...
        long tongtien = 0;
        LIST = GoiMonBUS.getThang(txtBan.getText());
        if (LIST.size() > 0) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Tháng nghỉ");
